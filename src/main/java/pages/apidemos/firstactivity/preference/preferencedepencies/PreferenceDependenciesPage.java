package pages.apidemos.firstactivity.preference.preferencedepencies;
...
public class PreferenceDependenciesPage extends BasePage {
    ...
    private final By wifiSettingBtn = AppiumBy.xpath("//android.widget.TextView[@resource-id=\"android:id/title\" and @text=\"WiFi settings\"]");
